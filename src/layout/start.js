...
module.exports = class extends DynamicProcessor {
	...
	_prepared(require) {
		...
		modules.forEach(
			module =>
				require(module) &&
				require(module.bundles) &&
				module.bundles.has('layout') &&
				require(module.bundles.get('layout'))
		);
	}
	...
	_process() {
		...
		this.#code = layouts.length ? `routing.config.layouts.register(${JSON.stringify(layouts)});\n` : undefined;
	}
};
